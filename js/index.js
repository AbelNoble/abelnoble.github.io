 ...
 */ !(function (t) {
  ...
  function (t, e, n) {
    ...
    window.tram = (function (t) {
      ...
      var l = (function (t, e, n) {
        ...
        R = function (t) {
          ...
          for (e = 0; e < T.length; e++)
            if ((n = T[e] + i) in O.style) return { dom: n, css: C[e] + t };
        },
        S = (e.support = {
      ...
      if (S.transition) {
        var z = S.timing.dom;
        if (((O.style[z] = f["ease-in-back"][0]), !O.style[z]))
      ...
      var M = (e.frame = (function () {
        ...
        $ = l(function (e) {
          ...
          (e.init = function (e) {
            ...
            S.backface &&
              U.hideBackface &&
              G(this.el, S.backface.css, "hidden");
          }),
            b("add", r),
            b("start", o),
            b("wait", function (t) {
          ...
          c.preview =
            function () {
              if (
                ...
                return;
              a.each(L), k(), i.resize.on(A);
            }),
          (c.destroy = function () {
            (_ = t()), k(), a && a.length && a.each(O);
          });
